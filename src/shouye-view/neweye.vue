<template>
  <div>
    <div class="top">
      <MyHeader><router-link to="/Home" class="iconfont icon-fanhui"></router-link>信工新闻眼</MyHeader>
    </div>
    <!--新闻-->
    <div class="news-list">
      <router-link :to="'/NEW1?id='+item._id" v-for="item in arr" :key="item.id" class="newsrow">
