<template>
  <div>
    <div class="top">
      <MyHeader><router-link to="/Home" class="iconfont icon-fanhui"></router-link>特色活动</MyHeader>
    </div>
    <!--新闻-->
    <div class="news-list">
      <router-link :to="'/NEW8?id='+item._id" v-for="item in arr" :key="item.id" class="newsrow">
...
<script>
  ...
  export default {
    ...
    mounted(){
      this.$axios.get("getTSHD").then(res=>{
