<template>
  <div>
    <div class="top">
      <MyHeader><router-link to="/Home" class="iconfont icon-fanhui"></router-link>党建一点通</MyHeader>
    </div>
    <!--新闻-->
    <div class="news-list">
      <router-link :to="'/NEW2?id='+item._id" v-for="item in arr" :key="item.id"  class="newsrow">
...
<script>
  ...
  export default {
    ...
    mounted(){
      this.$axios.get("getDJYDT").then(res=>{
