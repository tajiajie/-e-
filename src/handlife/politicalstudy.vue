<template>
  <div>
    <div class="top">
      <MyHeader><router-link to="/Zuzhilife" class="iconfont icon-fanhui"></router-link>政治学习</MyHeader>
    </div>
    <!--新闻-->
    <div class="news-list">
      <router-link :to="'/NEW4?id='+item._id" v-for="item in arr" :key="item.id" class="newsrow">
...
<script>
  ...
  export default {
    ...
    mounted(){
      this.$axios.get("getZZXX").then(res=>{
